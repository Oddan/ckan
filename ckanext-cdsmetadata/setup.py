...
setup(
    ...
    description='''Metadata for CO2DataShare''',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com//ckanext-cdsmetadata',

    # Author details
    author='''Odd Andersen''',
    author_email='''odd.andersen@sintef.no''',
    ...
    entry_points='''
        ...
        cdsexport=ckanext.cdsmetadata.cdssigma2_plugin:CdsSigma2Plugin
