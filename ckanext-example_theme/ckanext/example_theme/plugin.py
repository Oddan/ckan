...
def show_most_popular_groups():
    ...
    To enable showing the most popular groups, add this line to the [app:main]
...
class ExampleThemePlugin(plugins.SingletonPlugin):
    ...
    def update_config(self, config):
        ...
        # Add this plugin's tempalte dir to CKAN's extra_template_paths, so that
        # CKAN will use this plugin's custom templates.  'templates' is the path
        # to the tempaltes dir, relative to this plugin.py file.
    ...
    def get_helpers(self):
        ...
        # extension they belogn to, to avoid clashing with functions from other
        # extensions.
