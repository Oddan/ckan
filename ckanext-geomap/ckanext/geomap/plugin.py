...
natural_number_validator = plugins.toolkit.get_validator('natural_number_validator')
Invalid = plugins.toolkit.Invalid
...
class ReclineViewBase(plugins.SingletonPlugin):
    '''
    ...
    def update_config(self, config_):
        ...
        toolkit.add_resource('fanstatic', 'geomap')
...
class GeomapPlugin(ReclineViewBase):
    '''
    ...
    def info(self):
        ...
        return {'name': 'recline_map_view',
                ...
                'filterable': True,
                'icon': 'map-marker',
                'default_title': plugins.toolkit._('Map'),
                }
...
class GeomapPlugin(plugins.SingletonPlugin):
